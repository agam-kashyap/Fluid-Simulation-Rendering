...
bool SherLog::init( const SherLogSettings& settings )
{
...
std::string SherLog::prefix( const std::string& file , const int line ) 
{
	std::string result = "";
