...
//     glfwSetFramebufferSizeCallback(window, std::function<void(GLFWwindow*, int, int)> framebuffer_size_callback);
//     glfwSetCursorPosCallback(window, std::function<void(GLFWwindow*, double, double)> mouse_callback);
//     glfwSetScrollCallback(window, std::function<void(GLFWwindow*, double, double)> scroll_callback);
...
//     // ------------------------------------
//     Shader ourShader("../shaders/source.vert", "../shaders/source.frag");
